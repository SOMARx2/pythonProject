...
Original file is located at
    https://colab.research.google.com/drive/1HXRwp9Bwrdy6DWFRfg8aNRMgFA8g7WV-
...
if side1 >= side2 + side3 or side2 >= side1 + side3 or side3 >= side1 + side2:
  print("The triangle is not possible to draw")
else:
  print("The triangle is possible to draw")
...
if operation == "+":
  ...
  if num2 != 0:
    ...
    result = "It is not posible to divide by 0"
else:
    result = "Invalid operation"
